...
public class Agent extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        craetefarmBtn = (LinearLayout) findViewById(R.id.craetefarmBtn);
        ...
        craetefarmBtn.setOnClickListener(this);
...
//                toaster("Investor");
            ...
            case R.id.profile_btn:
                profile();
                break;
            case R.id.craetefarmBtn:
                navToNext(CreateFarm.class);
                break;
            case R.id.home_btn:
    ...
    public void toaster(String message) {
        Toast.makeText(Agent.this, message, Toast.LENGTH_SHORT).show();
    }

    public void navToNext(Class newIntent) {
        Intent intent = new Intent(Agent.this, newIntent);
        startActivity(intent);
    }

    private void profile(){
        profileDialog = new Dialog(Agent.this);
