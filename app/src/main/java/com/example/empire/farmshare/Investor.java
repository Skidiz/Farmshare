...
public class Investor extends AppCompatActivity implements View.OnClickListener {

    LinearLayout agentLayout, merchantLayout, investorLayout,
            resourcesLayout, profileLayout,portf_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        portf_btn = (LinearLayout) findViewById(R.id.portf_btn);
        ...
        portf_btn.setOnClickListener(this);
...
//                navToNext(Investor.class);
            ...
            case R.id.profile_btn:
                ...
                break;
            case R.id.portf_btn:
                navToNext(Investor_portfolio.class);
                break;
            case R.id.home_btn:
    ...
    public void toaster(String message) {
        Toast.makeText(Investor.this, message, Toast.LENGTH_SHORT).show();
    }

    public void navToNext(Class newIntent) {
        Intent intent = new Intent(Investor.this, newIntent);
        startActivity(intent);
    }

    private void profile(){
        profileDialog = new Dialog(Investor.this);
